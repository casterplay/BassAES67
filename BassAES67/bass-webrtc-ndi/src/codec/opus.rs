//! OPUS codec bindings for bass-webrtc-ndi.
//!
...
impl Encoder {
    ...
    pub fn new(
        ...
        let valid_frame_sizes = [
            format.sample_rate / 400,
            format.sample_rate / 200,
            format.sample_rate / 100,
            format.sample_rate / 50,
            format.sample_rate / 25,
            (format.sample_rate * 3) / 50,
        ];
    ...
    /// Create an encoder for audio at 48kHz stereo with 20ms frames
...
impl Decoder {
    ...
    /// Create a decoder for 48kHz stereo with 20ms frames
