//! RTP output bidirectional stream implementation.
//!
...
use crate::stream::input::BufferMode;
...
/// RTP output bidirectional stream configuration.
#[derive(Clone)]
...
pub struct OutputBidirectionalStats {
    /// TX packets sent
    pub tx_packets: u64,
    /// TX bytes sent
    pub tx_bytes: u64,
...
impl RtpOutputBidirectional {
    /// Create a new output bidirectional stream.
    ...
    pub fn stats(&self) -> OutputBidirectionalStats {
...
impl Drop for RtpOutputBidirectional {
    fn drop(&mut self) {
        self.stop();
    }
}

unsafe impl Send for RtpOutputBidirectional {}
